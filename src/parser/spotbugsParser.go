...
// func NewSpotBugsParser(parseFilePath string, query func(string, string) (int, error)) *SpotBugsParser {
...
// // 获取 CWE 字段
// func (s *SpotBugsParser) getCWEID(issueType string) (int, error) {
